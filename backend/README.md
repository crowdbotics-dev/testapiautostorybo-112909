...
## Project Structure
    ...
    ├── testapiautostorybo_112909  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112909`
...
2. Clone this repo and `cd testapiautostorybo_112909`
